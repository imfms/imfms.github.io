...
由于个人本身不是很喜欢国内在线的网盘，灵活性及，故在有了树莓派之后买了块硬盘挂载安装系统后就开始倒腾着安装网盘工具了。初期刚入手时是使用的基于php的[OwnCloud](https://owncloud.org/)，
测试使用期间发觉在树莓派上异常缓慢，遂放弃，无意间搜索到独立进程的Seafile, 试用一段后觉得性能体验比OwnCloud高出一筹，期间也没有遇到过什么大问题，便放心将网盘内容迁移到本地网盘服务器上，
